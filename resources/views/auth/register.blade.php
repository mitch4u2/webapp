                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('team') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="team" type="number" class="form-control" name="team" value="{{ old('team') }}" required autofocus>                                @if ($errors->has('name'))
                                <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control" name="birthday" value="{{ old('birthday') }}" required autofocus>                                @if ($errors->has('birthday'))
                                <span class="help-block">
